...
public class LambdaTest
{
	public static class AttributeCopier
	{
		...
		{
			setAttribute(dest, source, "alpha", (obj, value) -> obj.setAlpha(value));
			setAttribute(dest, source, "bravo", (obj, value) -> obj.setBravo(value));
			setAttribute(dest, source, "charlie", (obj, value) -> obj.setCharlie(value));
		}
	}
